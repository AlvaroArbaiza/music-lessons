...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .landing-bg {
                background: radial-gradient(1400px 600px at 70% -5%, rgba(165, 180, 252, 0.12), transparent 70%), linear-gradient(160deg, var(--bg-a), var(--bg-b));
                color: var(--ink);
            }
            ...
            .landing-bg::before {
                ...
                position: absolute;
                inset: 0;
                background-image: radial-gradient(circle at 1px 1px, rgba(148, 163, 184, 0.08) 1px, transparent 1px);
            ...
            .hero {
                ...
                box-shadow: 0 10px 30px -15px rgba(99, 102, 241, 0.08);
    ...
    <body class="antialiased">
        <div class="relative min-h-screen overflow-hidden landing-bg selection:bg-red-500 selection:text-white">
            <div class="container">
                <div class="topbar">
                    {{-- Top bar brand: estendibile con logo SVG ufficiale --}}
                    <div class="brand">
