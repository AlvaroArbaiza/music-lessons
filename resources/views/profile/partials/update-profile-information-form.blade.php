            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2" style="color: var(--text-primary);">
                        ...
                        <button form="send-verification" class="underline text-sm rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#16697a]" style="color: #5a6c7d;" onmouseover="this.style.color='#16697a'" onmouseout="this.style.color='#5a6c7d'">
